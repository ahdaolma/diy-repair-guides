...
export const metadata: Metadata = {
  title: "Privacy Policy | DIY Repair Guides",
  description: "Privacy policy for DIY Repair Guides. Learn how we handle your data.",
};
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none space-y-4">
        ...
        <h2>3. Contact</h2>
        <p>For privacy concerns, email us at contact@diyrepairguides.com.</p>
      </div>
    </div>
  );
}
